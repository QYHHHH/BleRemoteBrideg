...
static const st_parse_vec_t kParseVectors[] = {
  { "8-byte report, OK key in slot 0", kParseBytes_0, 8, 1, { { 0, false }, { 40, true } } },
  { "8-byte report, all slots zero means release", kParseBytes_1, 8, 1, { { 0, false }, { 0, false } } },
  { "8-byte report, TV key (0xC0)", kParseBytes_2, 8, 1, { { 0, false }, { 192, true } } },
  { "1-byte report, Volume Up", kParseBytes_3, 1, 1, { { 0, false }, { 128, true } } },
  { "1-byte report, zero means release", kParseBytes_4, 1, 1, { { 0, false }, { 0, false } } },
  { "1-byte report, Power (0x66)", kParseBytes_5, 1, 1, { { 0, false }, { 102, true } } },
  { "2-byte report, key in byte 1", kParseBytes_6, 2, 1, { { 0, false }, { 128, true } } },
  { "2-byte report, key in byte 0 fallback", kParseBytes_7, 2, 1, { { 0, false }, { 82, true } } },
  { "3-byte report, Back key at index 2", kParseBytes_8, 3, 1, { { 0, false }, { 241, true } } },
  { "3-byte report, all zero is release", kParseBytes_9, 3, 1, { { 0, false }, { 0, false } } },
  { "5-byte report, key in slot 1 of the slot region", kParseBytes_10, 5, 1, { { 0, false }, { 79, true } } },
  ...
  { "D-pad Right (0x4F) single byte", kParseBytes_15, 1, 1, { { 0, false }, { 79, true } } },
};
...
static const st_parse_vec_t kAtvvVectors[] = {
  { "AUDIO_START with HTT reason 0x03 is the voice button down", kAtvvBytes_0, 4, 1, { { 0, false }, { 4, true } } },
  { "AUDIO_STOP is the voice button up", kAtvvBytes_1, 1, 1, { { 0, false }, { 4, false } } },
  { "MIC_CLOSED is the voice button up", kAtvvBytes_2, 1, 1, { { 0, false }, { 4, false } } },
...
static const st_tracker_vec_t kTrackerVectors[] = {
  { "single press", kTrackerCodes_0, kTrackerPressed_0, 1, 1, { { 0, false }, { 128, true } } },
  { "duplicate press while held is swallowed", kTrackerCodes_1, kTrackerPressed_1, 2, 1, { { 0, false }, { 128, true } } },
  { "press then release", kTrackerCodes_2, kTrackerPressed_2, 2, 2, { { 0, false }, { 128, true }, { 128, false } } },
  { "duplicate release is swallowed", kTrackerCodes_3, kTrackerPressed_3, 3, 2, { { 0, false }, { 128, true }, { 128, false } } },
  { "release with nothing held emits nothing", kTrackerCodes_4, kTrackerPressed_4, 1, 0, { { 0, false } } },
  { "new key without a release auto-releases the old one", kTrackerCodes_5, kTrackerPressed_5, 2, 3, { { 0, false }, { 82, true }, { 82, false }, { 79, true } } },
  { "release after an auto-release pair", kTrackerCodes_6, kTrackerPressed_6, 3, 4, { { 0, false }, { 82, true }, { 82, false }, { 79, true }, { 79, false } } },
